...
# These keys are used for pushing changes to the GitLab repository.
# Please ensure these keys are kept secure and are not exposed publicly.
KEY FOR PUSHING: glpat-TMM3pxkm1Y8igK-9Jfv9
glpat-2zqauXEhSGdgnycuntz3