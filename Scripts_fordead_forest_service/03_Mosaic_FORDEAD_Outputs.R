...
#
# Inputs:
#   - Tiled FORDEAD outputs.
#   - Variable `index.list` (implicitly from `02_Execute_Core_FORDEAD_Processing.R`).
#
# Outputs:
#   - Merged GeoTIFFs and Shapefiles for various outputs in `for_out_path`.
#
# Operations:
...
# Some layers are mosaiced only for visualization purposes (not necessary for the following steps)

# Needed if the previous script was skipped for some reason
